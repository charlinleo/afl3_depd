...
import 'package:afl3_depd/data/app_exception.dart';
import 'package:afl3_depd/shared/shared.dart';
...
class NetworkApiServices implements BaseApiServices {
  ...
  @override
  Future<dynamic> postApiResponse(String 
  endpoint, dynamic data) async {
    dynamic responseJson;
    try {
      print("DATA");
      print(data);
